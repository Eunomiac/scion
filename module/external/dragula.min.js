    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            ...
            function lookupClass(className) {
                ...
                if (cached) {cached.lastIndex = 0} else {cache[className] = cached = new RegExp(start + className + end,"g")}
            ...
            function addClass(el, className) {
                ...
                if (!current.length) {el.className = className} else if (!lookupClass(className).test(current)) {el.className += ` ${ className}`}
            }
        ...
        2: [function(require, module, exports) {
            (function(global) {
                ...
                function dragula(initialContainers, options) {
                    ...
                    // reference move y
                        _initialSibling,
                    // reference sibling when grabbed
                        _currentSibling,
                    // reference sibling now
                        _copy,
                    ...
                    // last container item was over
                        _grabbed,
                    // holds mousedown context until first mousemove
                        _isSilent,
                    // throttles console messages

                        o = options || {};

                    const sheetElement = o.sheetElement ?? document.body;
                    console.dir({
                        containers:  initialContainers.map((container) => container.classList.join(", ")),
                        sheetElement
                    });
                    ...
                    function grab(e) {
                        ...
                        if (e.type === "mousedown") {
                            ...
                            {item.focus()}
                                // fixes https://github.com/bevacqua/dragula/issues/176
                            else {e.preventDefault()}
                        }
                                // fixes https://github.com/bevacqua/dragula/issues/155
                    }
                    ...
                    function startBecauseMouseMoved(e) {
                        ...
                        if (whichMouseButton(e) === 0) {
                            release({});
                            return;
                            // when text is selected on an input and then dragged, mouseup doesn't fire. this is our only hope
                        }
                    ...
                    function release(e) {
                        ...
                        if (dropTarget && ((_copy && o.copySortSource) || (!_copy || dropTarget !== _source))) {drop(item, dropTarget)} else if (o.removeOnSpill) {remove()} else {cancel()}
                    }

                    function drop(item, target) {
                        const parent = getParent(item);
                        if (_copy && o.copySortSource && target === _source) {parent.removeChild(_item)}
                    ...
                    function cleanup() {
                        ...
                        ungrab();
                        removeMirrorImage();
                        if (item) {classes.rm(item, "gu-transit")}

                        if (_renderTimer) {clearTimeout(_renderTimer)}

                        drake.dragging = false;
                        if (_lastDropTarget) {drake.emit("out", item, _lastDropTarget, _source)}
                    ...
                    function isInitialPlacement(target, s) {
                        let sibling;
                        if (s !== void 0) {sibling = s} else if (_mirror) {sibling = _currentSibling} else {sibling = nextEl(_copy || _item)}
                    ...
                    function findDropTarget(elementBehindCursor, clientX, clientY) {
                        ...
                        function accepted() {
                            ...
                            if (initial) {return true}
                                // should always be able to drop it right back where it was
                    ...
                    function drag(e) {
                        ...
                        const clientX = getCoord("clientX", e) || 0;
                        const clientY = getCoord("clientY", e) || 0;
                        const x = clientX - _offsetX - Number(sheetElement.style.left.slice(0, -2));
                        const y = clientY - _offsetY - Number(sheetElement.style.top.slice(0, -2));
                        ...
                        if (!_isSilent) {
                            _isSilent = true;
                            console.log(`C:[${clientX}, ${clientY}] - O:[${_offsetX}, ${_offsetY}] - S:[${Number(sheetElement.style.left.slice(0, -2))}, ${Number(sheetElement.style.top.slice(0, -2))}] = [${x}, ${y}]`);
                            console.log({sheetElement, mirrorContainer: o.mirrorContainer, draggedElement: _mirror});
                            setTimeout(() => _isSilent = false, 500);
                        }
                ...
                function nextEl(el) {
                    ...
                    function manually() {
                        ...
                        while (sibling && sibling.nodeType !== 1);return sibling;
                    }
                }
        ...
        6: [function(require, module, exports) {
            (function(global) {
                ...
                function fabricateEvent(el, type, model) {
                    ...
                    if (el.dispatchEvent) {el.dispatchEvent(e)} else {el.fireEvent(`on${ type}`, e)}
        ...
        7: [function(require, module, exports) {
            (function(global) {
                ...
                for (eventname in global) {
                    if (ron.test(eventname)) {eventmap.push(eventname.slice(2))}
                }
        ...
        8: [function(require, module, exports) {
            (function(global) {
                ...
                function useNative() {
                    try {
                        const p = new NativeCustomEvent("cat",{
                            detail: {
                                foo: "bar"
                            }
                        });
     ...
     */
        ...
        11: [function(require, module, exports) {
            (function(setImmediate, clearImmediate) {
                let {nextTick} = require("process/browser.js"),
