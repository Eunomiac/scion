...
const logStyles = {
    ...
    trace: "color: black; background-color: #AAA; font-family: 'Fira Code'; font-weight: bold; font-size: 10px; padding: 0 3px;",
...
const logGroup = (outputs, groupTitle, tag, {style, groupStyle}, stackTrace) => {
    if (["number", "string"].includes(typeof outputs)) {
        ...
        if (stackTrace)
            logGroup(stackTrace, "STACK TRACE", null, {style: "trace", groupStyle: "trace"});
        console.groupEnd();
    }
};
